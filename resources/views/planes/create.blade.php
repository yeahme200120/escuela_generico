<x-layouts.app page-title="Nuevo Planes de Estudio">
<x-ui.page-header title="Nuevo Planes de Estudio"
    :items="[['label'=>'Planes de Estudio','url'=>route('planes.index')],['label'=>'Nuevo']]" />
