<x-layouts.app page-title="Periodo de Evaluación">
<x-ui.page-header title="Periodo de Evaluación"
    :items="[['label'=>'Periodo de Evaluación','url'=>route('periodos-evaluacion.index')],['label'=>'Detalle']]">
    <x-slot name="actions">
