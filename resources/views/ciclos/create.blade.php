...
<div class="container-fluid">
    <x-ui.page-header title="Nuevo Ciclo Escolar" subtitle="Registrar un periodo académico" :actions="[['label' => 'Volver', 'route' => route('ciclos.index')]]" />
    <x-ui.card>
            ...
            <div class="row g-3">
                ...
                <div class="col-md-12">
                    <div class="form-check">
                        <input type="checkbox" name="es_actual" value="1" {{ old('es_actual') ? 'checked' : '' }} class="form-check-input">
