<x-layouts.app page-title="Sede">
<x-ui.page-header title="Sede"
    :items="[['label'=>'Sede','url'=>route('sedes.index')],['label'=>'Detalle']]">
    <x-slot name="actions">
        <a href="{{ route('sedes.edit',$item) }}" class="btn btn-sm btn-outline-primary">Editar</a>
    </x-slot>
</x-ui.page-header>
<x-ui.card>
