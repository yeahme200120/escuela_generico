...
<div class="container-fluid">
    <x-ui.page-header 
        title="Nueva Sede" 
        subtitle="Registrar un campus o plantel"
        :actions="[
    ...
    <x-ui.card>
        <form action="{{ route('sedes.store') }}" method="POST" novalidate>
            @csrf
            ...
            <div class="row g-3">
                ...
                <div class="col-md-4">
                    ...
                    <input type="text" name="estado" id="estado" class="form-control @error('estado') is-invalid @enderror" 
                           value="{{ old('estado') }}" maxlength="100">
                ...
                <div class="col-md-4">
                    ...
                    <input type="text" name="pais" id="pais" class="form-control @error('pais') is-invalid @enderror" 
                           value="{{ old('pais', 'México') }}" maxlength="100">
                ...
                <div class="col-md-4">
                    ...
                    <input type="number" step="any" name="latitud" id="latitud" class="form-control @error('latitud') is-invalid @enderror" 
                           value="{{ old('latitud') }}" placeholder="Ej: 19.4326">
                ...
                <div class="col-md-4">
                    ...
                    <input type="number" step="any" name="longitud" id="longitud" class="form-control @error('longitud') is-invalid @enderror" 
                           value="{{ old('longitud') }}" placeholder="Ej: -99.1332">
                ...
                <div class="col-md-4">
                    ...
                    <input type="number" name="radio_geocerca_metros" id="radio_geocerca_metros" 
                           ...
                           value="{{ old('radio_geocerca_metros', 500) }}" min="0">
                ...
                <div class="col-md-3">
                    ...
                    <input type="number" step="0.01" name="calificacion_minima" id="calificacion_minima" 
                           ...
                           value="{{ old('calificacion_minima', 6.00) }}" min="0" max="10">
                ...
                <div class="col-md-3">
                    ...
                    <input type="number" step="0.01" name="calificacion_maxima" id="calificacion_maxima" 
                           ...
                           value="{{ old('calificacion_maxima', 10.00) }}" min="0" max="10">
                ...
                <div class="col-md-3">
                    ...
                    <input type="number" name="tolerancia_retardo_minutos" id="tolerancia_retardo_minutos" 
                           ...
                           value="{{ old('tolerancia_retardo_minutos', 10) }}" min="0">
                ...
                <div class="col-md-3">
                    ...
                    <input type="text" name="moneda" id="moneda" class="form-control @error('moneda') is-invalid @enderror" 
                           value="{{ old('moneda', 'MXN') }}" maxlength="10">
                ...
                <div class="col-md-6">
                    ...
                    <select name="zona_horaria" id="zona_horaria" class="form-control @error('zona_horaria') is-invalid @enderror">
                        <option value="America/Mexico_City" {{ old('zona_horaria', 'America/Mexico_City') == 'America/Mexico_City' ? 'selected' : '' }}>Ciudad de México (CDMX)</option>
                        <option value="America/Monterrey" {{ old('zona_horaria') == 'America/Monterrey' ? 'selected' : '' }}>Monterrey</option>
                        <option value="America/Guadalajara" {{ old('zona_horaria') == 'America/Guadalajara' ? 'selected' : '' }}>Guadalajara</option>
                        <option value="America/Tijuana" {{ old('zona_horaria') == 'America/Tijuana' ? 'selected' : '' }}>Tijuana</option>
                        <option value="America/Merida" {{ old('zona_horaria') == 'America/Merida' ? 'selected' : '' }}>Mérida</option>
                        <option value="America/Chihuahua" {{ old('zona_horaria') == 'America/Chihuahua' ? 'selected' : '' }}>Chihuahua</option>
                        <option value="America/Hermosillo" {{ old('zona_horaria') == 'America/Hermosillo' ? 'selected' : '' }}>Hermosillo</option>
                    </select>
                ...
                <div class="col-md-6">
                    ...
                    <textarea name="configuracion" id="configuracion" rows="2" 
                              ...
                              placeholder='{"clave":"valor", "otra":"config"}'>{{ old('configuracion') }}</textarea>
