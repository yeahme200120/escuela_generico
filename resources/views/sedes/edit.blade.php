<x-layouts.app page-title="Editar Sedes">
<x-ui.page-header title="Editar Sedes"
    :items="[['label'=>'Sedes','url'=>route('sedes.index')],['label'=>'Editar']]" />
<form method="POST" action="{{ route('sedes.update',$item) }}">
@csrf @method('PUT')
...
<div class="d-flex gap-2 mt-3">
    ...
    <a href="{{ route('sedes.show',$item) }}" class="btn btn-outline-secondary">Cancelar</a>
</div>
</form>
</x-layouts.app>