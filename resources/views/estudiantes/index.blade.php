<x-layouts.app page-title="Estudiantes">
<x-ui.page-header title="Estudiantes">
    <x-slot name="actions">
        <a href="{{ route('estudiantes.create') }}" class="btn btn-primary btn-sm">+ Nuevo</a>
    </x-slot>
</x-ui.page-header>
        ...
        <table class="table table-se table-hover mb-0">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-end">
                        <a href="{{ route('estudiantes.show',$item) }}" class="btn btn-sm btn-outline-secondary">Ver</a>
                        <a href="{{ route('estudiantes.edit',$item) }}" class="btn btn-sm btn-outline-primary ms-1">Editar</a>
                    </td>
                </tr>
                @empty
