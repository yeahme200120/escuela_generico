<x-layouts.app page-title="Editar Horarios">
<x-ui.page-header title="Editar Horarios"
    :items="[['label'=>'Horarios','url'=>route('horarios.index')],['label'=>'Editar']]" />
    ...
    <div class="row g-3">
                <div class="col-md-6">
                    ...
                    <input type="text" name="dia_semana" class="form-control @error('dia_semana') is-invalid @enderror"
                           value="{{ old('dia_semana',$item->dia_semana) }}">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" name="hora_inicio" class="form-control @error('hora_inicio') is-invalid @enderror"
                           value="{{ old('hora_inicio',$item->hora_inicio) }}">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" name="hora_fin" class="form-control @error('hora_fin') is-invalid @enderror"
                           value="{{ old('hora_fin',$item->hora_fin) }}">
...
<div class="d-flex gap-2 mt-3">
    ...
    <a href="{{ route('horarios.show',$item) }}" class="btn btn-outline-secondary">Cancelar</a>
</div>
</form>
</x-layouts.app>