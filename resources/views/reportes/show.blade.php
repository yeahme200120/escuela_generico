<x-layouts.app page-title="Reporte">
<x-ui.page-header title="Reporte"
    :items="[['label'=>'Reporte','url'=>route('reportes.index')],['label'=>'Detalle']]">
    <x-slot name="actions">
        <a href="{{ route('reportes.edit',$item) }}" class="btn btn-sm btn-outline-primary">Editar</a>
    </x-slot>
</x-ui.page-header>
<x-ui.card>
