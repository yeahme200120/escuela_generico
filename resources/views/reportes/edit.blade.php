<x-layouts.app page-title="Editar Reporte">
<x-ui.page-header title="Editar Reporte" />
        ...
        <table class="table table-se table-hover mb-0">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-end">
                        <a href="{{ route('reportes.show',$item) }}" class="btn btn-sm btn-outline-secondary">Ver</a>
                        <a href="{{ route('reportes.edit',$item) }}" class="btn btn-sm btn-outline-primary ms-1">Editar</a>
                    </td>
                </tr>
                @empty
