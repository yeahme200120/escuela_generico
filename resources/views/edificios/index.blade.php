<x-layouts.app page-title="Edificios">
<x-ui.page-header title="Edificios" />
        ...
        <table class="table table-se table-hover mb-0">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-end">
                        <a href="{{ route('edificios.show',$item) }}" class="btn btn-sm btn-outline-secondary">Ver</a>
                        <a href="{{ route('edificios.edit',$item) }}" class="btn btn-sm btn-outline-primary ms-1">Editar</a>
                    </td>
                </tr>
                @empty
