<x-layouts.app page-title="Aulas">
<x-ui.page-header title="Aulas" />
        ...
        <table class="table table-se table-hover mb-0">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-end">
                        <a href="{{ route('aulas.show',$item) }}" class="btn btn-sm btn-outline-secondary">Ver</a>
                        <a href="{{ route('aulas.edit',$item) }}" class="btn btn-sm btn-outline-primary ms-1">Editar</a>
                    </td>
                </tr>
                @empty
