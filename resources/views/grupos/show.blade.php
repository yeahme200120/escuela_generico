<x-layouts.app page-title="Grupo">
<x-ui.page-header title="Grupo"
    :items="[['label'=>'Grupo','url'=>route('grupos.index')],['label'=>'Detalle']]">
    <x-slot name="actions">
        <a href="{{ route('grupos.edit',$item) }}" class="btn btn-sm btn-outline-primary">Editar</a>
    </x-slot>
</x-ui.page-header>
<x-ui.card>
